...
const page = () => {
    ...
    const titles = ["SL", "Store Information", "Module", "Owner Information", "Zone", "Status", "Action"]
    ...
    return (
        <>
            ...
            <div style={{
                ...
                {pagination("Pending Store", "/store/pending-requests", true)}
                {pagination("Denied Store", "/store/deny-requests", false)}
            </div>
            <CustomBox>
                <div style={{
                    display: "flex",
